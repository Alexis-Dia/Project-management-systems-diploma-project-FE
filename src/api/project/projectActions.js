...
export const USER_WAS_SUCCESSFULLY_ADDED_TO_THE_PROJECT = 'User was successfully added to the project!';
export const USER_WAS_SUCCESSFULLY_REMOVED_FROM_THE_PROJECT = 'User was successfully removed from the project!';
...
export const REMOVE_USER_FROM_THE_PROJECT = 'REMOVE_USER_FROM_THE_PROJECT';
